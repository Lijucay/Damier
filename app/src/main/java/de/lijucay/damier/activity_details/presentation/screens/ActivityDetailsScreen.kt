package de.lijucay.damier.activity_details.presentation.screens
...
//                useLimitTheme = state.useLimitTheme,
                ...
                onEditLabelClicked = { chipId, label ->
                    nfcViewModel.setUpdateLabel(
                        chipId,
                        label
                    )
                },
    ...
    item {
        Row(
            ...
            AnimatedBadge(
                ...
                text = "${state.todaysTotal} $unitName"
            )
        }
        Spacer(modifier = Modifier.height(6.dp))
    }
