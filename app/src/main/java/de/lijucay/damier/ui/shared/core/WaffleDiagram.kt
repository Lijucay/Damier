...
fun WaffleDiagram(
    ...
    BoxWithConstraints(
        ...
        val data = remember(checkIns) {
            checkIns.groupingBy { it.dateTime.value.toLocalDate() }
                .fold(0) { acc, checkInUi -> acc + checkInUi.checkInCount }
        }
